...
public class AuthenticationService {
    ...
    public boolean verifyWebCode(Player player, String code) {
        ...
        if (redisService.exists(key)) {
            ...
            if (expectedPlayerId != null
                    && expectedPlayerId.equals(player.getUniqueId().toString())) {
    ...
    /**
     * Stores user information in the Redis database for the given code If user information is
     * already stored, it just resets the TTL
     *
